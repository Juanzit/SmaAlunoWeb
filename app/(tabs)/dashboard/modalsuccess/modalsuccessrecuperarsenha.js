    ...
    const router = useRouter();
        return (
            <View style={[estilo.corLightMenos1, style.container]}>
                ...
                <Text style={[estilo.centralizado, estilo.textoP16px, estilo.textoCorSecundaria]}>Senha recuperada com sucesso!</Text>
                <TouchableOpacity style={[estilo.corSuccess, style.botaoConfirma, estilo.centralizado]} onPress={()=> router.push('../navegacaologinscreen')}>
